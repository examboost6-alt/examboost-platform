    ...
    <AdminLayout>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
            <div className="absolute -top-32 -right-32 w-64 h-64 bg-primary/10 blur-3xl rounded-full pointer-events-none"></div>
            <div className="flex justify-between items-center mb-6 relative z-10">
                <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-primary/10 border border-blue-100 dark:border-primary/20 flex items-center justify-center shrink-0">
                ...
                <div className="text-right">
                    <span className="text-3xl font-black text-primary dark:text-primary">{stats.avgSystemScore}</span>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-end pt-8 pb-2 relative h-56 border-b border-slate-100 dark:border-slate-800">
                ...
                <path 
                    ...
                    stroke="currentColor" 
                    strokeWidth="2.5" 
                    className="text-primary dark:text-primary drop-shadow-md"
                />
                <path 
            ...
            >
            <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-secondary/10 blur-3xl rounded-full pointer-events-none"></div>
            <div className="flex justify-between items-center mb-6 relative z-10">
                <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-2xl bg-indigo-50 dark:bg-secondary/10 border border-indigo-100 dark:border-secondary/20 flex items-center justify-center shrink-0">
                    <PieChart className="w-6 h-6 text-secondary dark:text-secondary" />
                </div>
                <div>
                ...
                {stats.categoryDistribution.length > 0 ? stats.categoryDistribution.map((item, i) => (
                    <div key={i} className="flex justify-between items-center group">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-bold text-slate-700 dark:text-slate-300 group-hover:text-secondary transition-colors uppercase tracking-wide">{item.name}</span>
                        </div>
                        <div className="text-right">
        ...
        >
             <div className="p-8 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-[#020617]/30">
               <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-secondary/10 border border-secondary/20 flex items-center justify-center shrink-0">
                     <TrendingUp className="w-7 h-7 text-secondary dark:text-secondary" />
                  </div>
                  <div>
             ...
             <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 <div className="bg-slate-50 dark:bg-[#020617] rounded-3xl p-6 border border-slate-100 dark:border-slate-800 shadow-inner flex flex-col items-center justify-center text-center">
                     ...
                     <div className="text-5xl font-black text-secondary dark:text-secondary">{stats.traffic.totalVisits}</div>
               ...
               <div className="grid grid-cols-1 divide-y divide-slate-100 dark:divide-slate-800/60">
                ...
                <div key={i} className="flex flex-col md:flex-row justify-between md:items-center gap-6 p-6 md:px-8 hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors group">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-3 border border-slate-100 dark:border-slate-800">
                        ...
                        <span className="font-black text-secondary dark:text-secondary text-lg">{test.avgScore}</span>
                    </div>
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-3 border border-slate-100 dark:border-slate-800">
