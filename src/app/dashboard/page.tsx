...
export default function StudentDashboard() {
  ...
  const AllCoursesModule = () => {
    ...
    const mockPackages = [
      // Engineering
      { id: 'mock-eng-1', title: 'Shikhar JEE Main 2026 Test Series', tags: ['Engineering', '₹1299'], exam: 'Engineering', description: 'Experience the real NTA interface with 15 Premium Full-Length Mock Tests exclusively for JEE Main preparation.', features: ['15 Premium Full Mocks', 'Advanced Accuracy Analytics', 'Deep Insights & History', 'Rank Prediction'], imageUrl: '/shikhar-jee.png' },
