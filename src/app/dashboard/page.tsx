...
export default function StudentDashboard() {
  ...
  const AllCoursesModule = () => {
    ...
    const mockPackages = [
      ...
      { id: 'mock-eng-2', title: 'Vijay IIT Advance 2026 Test Series', tags: ['Engineering', '₹1999'], exam: 'Engineering', description: '35+ Tests + Unlimited Practice. Exclusively designed for IIT JEE Advanced 2026 aspirants.', features: ['25 Full JEE Advanced Mocks', '10 Previous Year Papers', 'Unlimited Chapter Wise Tests', 'Unlimited Custom Mock Generator'], imageUrl: '/vijay-jee-advance.png' },
      ...
      // Medical
      { id: 'mock-med-1', title: 'All India Aakash-Level NEET Test Series', tags: ['Medical', '₹999'], exam: 'Medical', description: '100% NCERT aligned. 20 Full mock tests matching exact NEET UG difficulty level.', features: ['20 Full NCERT Based Tests', 'Biology Target 360', 'Assertion-Reason Bank', 'National Level Percentile'] },
