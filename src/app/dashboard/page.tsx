...
const mockPackages = [
  ...
  // Medical
  { id: 'mock-med-1', title: 'ExamBoost NEET Shourya Test Series 2026', tags: ['Medical', '₹1499'], exam: 'Medical', description: '25 Premium Tests + AI Practice. Build your accuracy with tests simulating the latest NEET UG exam pattern.', features: ['15 Full NEET Mock Tests', '5 Previous Year Papers', '5 Intensive Tests', 'Unlimited Custom Mock Generator'], imageUrl: '/shourya-neet.png' },
