                ...
                <div>
                  ...
                  <div className="flex flex-col gap-4">
                    {tests.map((test, index) => {
                      ...
                      <div 
                        key={test.id} 
                        className={`group flex flex-col sm:flex-row items-start sm:items-center justify-between p-5 rounded-2xl border transition-all gap-4 ${
                          isIntensive 
                      ...
                      >
                        ...
                        {!test.isLocked ? (
                          <Link 
                            ...
                            className={`w-full sm:w-auto px-5 py-2.5 rounded-xl border font-bold text-sm flex items-center justify-center gap-2 transition-all shrink-0 ${
                              isIntensive 
