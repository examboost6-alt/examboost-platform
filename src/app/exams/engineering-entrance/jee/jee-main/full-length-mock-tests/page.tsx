...
export const metadata = {
  title: 'JEE Main Full Length Mock Tests Preparation - ExamBoost',
  description: 'Comprehensive preparation resources, mock tests, and study materials for JEE Main Full Length Mock Tests.'
};

export default function FullLengthMockTestsPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] pt-24 w-full">
      ...
      <div className="relative overflow-hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 relative z-10">
          <div className="flex items-center gap-2 text-sm font-semibold text-primary dark:text-accent mb-6 flex-wrap">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-slate-500 dark:text-slate-400">JEE Main Full Length Mock Tests</span>
          </div>
          
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white mb-6 leading-tight">
              Master the <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary dark:from-accent dark:to-primary">JEE Main Full Length Mock Tests</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              Top-tier study materials, interactive mock tests, and expert guidance to help you secure top ranks in your JEE Main Full Length Mock Tests journey.
            </p>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16">
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Popular Resources for JEE Main Full Length Mock Tests</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((item) => (
            <div key={item} className="bg-white dark:bg-[#0f172a] rounded-2xl p-6 border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-primary dark:group-hover:text-accent transition-colors">JEE Main Full Length Mock Tests Material {item}</h3>
      ...
      <TestSeriesPackages examName="JEE Main Full Length Mock Tests" />
