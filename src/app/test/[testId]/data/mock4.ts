...
const physicsQuestions_4: any[] = [
    { type: 'MCQ', textEn: "The velocity of a particle is given by v = 3t² - 6t + 2. What is its acceleration at t = 2 s?", textHi: "एक कण का वेग v = 3t² - 6t + 2 है। t = 2 s पर त्वरण क्या होगा?", options: [{en: "0 m/s²", hi: "0 m/s²"}, {en: "6 m/s²", hi: "6 m/s²"}, {en: "12 m/s²", hi: "12 m/s²"}, {en: "-6 m/s²", hi: "-6 m/s²"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The formula for power loss in a transmission circuit is mostly given by:", textHi: "संचरण परिपथ में शक्ति हानि (Power loss) का सूत्र मुख्य रूप से किसके द्वारा दिया जाता है?", options: [{en: "V²R", hi: "V²R"}, {en: "I²R", hi: "I²R"}, {en: "IR", hi: "IR"}, {en: "V/I", hi: "V/I"}], ans: 2 },
    ...
    { type: 'Numerical', textEn: "A body has an initial velocity of 2 m/s and an acceleration of 5 m/s². What will be its velocity after 4 seconds?", textHi: "एक पिंड का प्रारंभिक वेग 2 m/s और त्वरण 5 m/s² है। 4 सेकंड बाद इसका वेग क्या होगा?", ans: "22" },
...
const chemistryQuestions_4: any[] = [
    { type: 'MCQ', textEn: "RCOOH + SOCl₂ → RCOCl. Further reaction of this product with NH₃ yields:", textHi: "RCOOH + SOCl₂ → RCOCl. इस उत्पाद की NH₃ के साथ आगे की प्रतिक्रिया से क्या प्राप्त होता है?", options: [{en: "RCONH₂ + HCl (Amide)", hi: "RCONH₂ + HCl (एमाइड)"}, {en: "RCOONH₄", hi: "RCOONH₄"}, {en: "RCONH₂ + SO₂", hi: "RCONH₂ + SO₂"}, {en: "No reaction", hi: "कोई प्रतिक्रिया नहीं"}], ans: 1 },
    { type: 'MCQ', textEn: "Which ligand order of stability is correct according to spectrochemical series?", textHi: "स्पेक्ट्रोकेमिकल श्रृंखला के अनुसार स्थिरता का कौन सा लिगैंड क्रम सही है?", options: [{en: "CN⁻ > NH₃ > H₂O > OH⁻", hi: "CN⁻ > NH₃ > H₂O > OH⁻"}, {en: "NH₃ > CN⁻ > H₂O", hi: "NH₃ > CN⁻ > H₂O"}, {en: "H₂O > NH₃ > OH⁻", hi: "H₂O > NH₃ > OH⁻"}, {en: "OH⁻ > CN⁻ > NH₃", hi: "OH⁻ > CN⁻ > NH₃"}], ans: 1 },
    { type: 'MCQ', textEn: "Geometry of XeF₆ is:", textHi: "XeF₆ की ज्यामिति है:", options: [{en: "Distorted octahedral", hi: "विकृत अष्टफलकीय"}, {en: "Pentagonal bipyramidal", hi: "पंचकोणीय द्विपिरामिडीय"}, {en: "Trigonal bipyramidal", hi: "त्रिकोणीय द्विपिरामिडीय"}, {en: "Square pyramidal", hi: "वर्ग पिरामिडीय"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "For H₂-O₂ fuel cell, E°=1.23V. What is ΔG°? (n=4)", textHi: "H₂-O₂ ईंधन सेल के लिए, E°=1.23V है। ΔG° क्या है? (n=4)", options: [{en: "-474.7 kJ/mol", hi: "-474.7 kJ/mol"}, {en: "-237.3 kJ/mol", hi: "-237.3 kJ/mol"}, {en: "474.7 kJ/mol", hi: "474.7 kJ/mol"}, {en: "-948 kJ/mol", hi: "-948 kJ/mol"}], ans: 1 },
    { type: 'MCQ', textEn: "CH₃CH₂COCH₃ + I₂/NaOH yields majorly:", textHi: "CH₃CH₂COCH₃ + I₂/NaOH मुख्य रूप से देता है:", options: [{en: "CH₃CH₂COONa + CHI₃", hi: "CH₃CH₂COONa + CHI₃"}, {en: "CH₃COCH₂CH₃ + CHI₃", hi: "CH₃COCH₂CH₃ + CHI₃"}, {en: "No reaction", hi: "कोई प्रतिक्रिया नहीं"}, {en: "CH₃CH₂CHI₂ + HCOONa", hi: "CH₃CH₂CHI₂ + HCOONa"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "A 2nd group cation's precipitate dissolves in NH₄OH to form soluble [H₃N-Zn-NH₃]²⁺ like complex. This cation acts amphoteric?", textHi: "2nd समूह के धनायन का अवक्षेप NH₄OH में घुलकर घुलनशील संकुल बनाता है:", options: [{en: "Zn²⁺ (Wait, Zn is group IV)", hi: "Zn²⁺ (Zn समूह IV है)"}, {en: "Cu²⁺ forming deep blue solution", hi: "Cu²⁺ गहरा नीला विलयन बनाता है"}, {en: "PbS insoluble", hi: "PbS अघुलनशील"}, {en: "HgS black", hi: "HgS काला"}], ans: 2 },
    { type: 'MCQ', textEn: "Which of the following compounds has the transition metal in +7 oxidation state?", textHi: "निम्नलिखित में से किस यौगिक में संक्रमण धातु +7 ऑक्सीकरण अवस्था में है?", options: [{en: "KMnO₄", hi: "KMnO₄"}, {en: "K₂Cr₂O₇", hi: "K₂Cr₂O₇"}, {en: "K₂FeO₄", hi: "K₂FeO₄"}, {en: "MnO₂", hi: "MnO₂"}], ans: 1 },
    { type: 'MCQ', textEn: "Correct order of +R effect (resonance donating):", textHi: "+R प्रभाव (अनुनाद दान) का सही क्रम:", options: [{en: "-NH₂ > -OH > -OR", hi: "-NH₂ > -OH > -OR"}, {en: "-OR > -OH > -NH₂", hi: "-OR > -OH > -NH₂"}, {en: "-OH > -NH₂ > -OR", hi: "-OH > -NH₂ > -OR"}, {en: "-NH₂ > -OR > -OH", hi: "-NH₂ > -OR > -OH"}], ans: 1 },
    { type: 'MCQ', textEn: "The van't Hoff factor (i) for fully dissociated 0.1m Na₃PO₄ is:", textHi: "पूरी तरह से विघटित 0.1m Na₃PO₄ के लिए वान्ट हॉफ गुणक (i) क्या है?", options: [{en: "4", hi: "4"}, {en: "3", hi: "3"}, {en: "2", hi: "2"}, {en: "1", hi: "1"}], ans: 1 },
    { type: 'MCQ', textEn: "Fraction of ¹⁴C remaining after 11520 years (t½ = 5760 yr) is:", textHi: "11520 वर्षों के बाद (t½ = 5760 वर्ष) बचे हुए ¹⁴C का अंश (Fraction) होगा:", options: [{en: "1/4", hi: "1/4"}, {en: "1/2", hi: "1/2"}, {en: "1/8", hi: "1/8"}, {en: "3/4", hi: "3/4"}], ans: 1 },
    { type: 'MCQ', textEn: "H₂ effuses 4 times faster than a gas X. The identity of X is:", textHi: "H₂ गैस X की तुलना में 4 गुना तेजी से निःसरित (effuse) होती है। X की पहचान क्या है?", options: [{en: "O₂", hi: "O₂"}, {en: "CH₄", hi: "CH₄"}, {en: "CO₂", hi: "CO₂"}, {en: "N₂", hi: "N₂"}], ans: 1 },
    { type: 'MCQ', textEn: "The correct order of acidic strength is:", textHi: "अम्लीय सामर्थ्य (acidic strength) का सही क्रम है:", options: [{en: "H₂O < HF < HCl < HBr < HI", hi: "H₂O < HF < HCl < HBr < HI"}, {en: "HI < HBr < HCl < HF < H₂O", hi: "HI < HBr < HCl < HF < H₂O"}, {en: "H₂O < HI < HBr < HCl < HF", hi: "H₂O < HI < HBr < HCl < HF"}, {en: "HF < H₂O < HCl < HBr < HI", hi: "HF < H₂O < HCl < HBr < HI"}], ans: 1 },
    { type: 'MCQ', textEn: "The IUPAC name of [Cr(en)₂Cl₂]⁺ is:", textHi: "[Cr(en)₂Cl₂]⁺ का IUPAC नाम है:", options: [{en: "Dichlorobis(ethylenediamine)chromium(III) ion", hi: "डाइक्लोरोबिस(एथिलीनडायमाइन)क्रोमियम(III) आयन"}, {en: "Bis(ethylenediamine)dichlorochromium(III) ion", hi: "बिस(एथिलीनडायमाइन)डाइक्लोरोक्रोमियम(III) आयन"}, {en: "Ethylenediaminedichlorochromium(III) ion", hi: "एथिलीनडायमाइनडाइक्लोरोक्रोमियम(III) आयन"}, {en: "Chromiumdichlorobis(ethylenediamine) ion", hi: "क्रोमियमडाइक्लोरोबिस(एथिलीनडायमाइन) आयन"}], ans: 1 },
    { type: 'MCQ', textEn: "CH₃CH₂CHBrCH₃ reacts with alcoholic KOH. The major product is:", textHi: "CH₃CH₂CHBrCH₃ एल्कोहॉलिक KOH के साथ प्रतिक्रिया करता है। मुख्य उत्पाद है:", options: [{en: "2-butene (Zaitsev product)", hi: "2-ब्यूटीन (ज़ैतसेव उत्पाद)"}, {en: "1-butene", hi: "1-ब्यूटीन"}, {en: "Both 1-butene and 2-butene equally", hi: "1-ब्यूटीन और 2-ब्यूटीन दोनों बराबर"}, {en: "No reaction", hi: "कोई प्रतिक्रिया नहीं"}], ans: 1 },
    { type: 'MCQ', textEn: "Which ion undergoes disproportionation in aqueous solution?", textHi: "जलीय विलयन में कौन सा आयन असमानुपातन (disproportionation) से गुजरता है?", options: [{en: "Cu⁺ → Cu + Cu²⁺", hi: "Cu⁺ → Cu + Cu²⁺"}, {en: "Fe²⁺", hi: "Fe²⁺"}, {en: "Mn²⁺", hi: "Mn²⁺"}, {en: "Cr³⁺", hi: "Cr³⁺"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "Specific conductance κ = 0.005 S/cm, Concentration C = 0.2 M. Find Molar conductance Λm in S cm²/mol.", textHi: "विशिष्ट चालकता κ = 0.005 S/cm, सांद्रता C = 0.2 M है। मोलर चालकता Λm (S cm²/mol में) ज्ञात करें।", ans: "25" },
    ...
    { type: 'Numerical', textEn: "For a second-order reaction, [A]₀ = 0.5M, k = 0.2 L/mol.min. Find time t (in min) when [A] = 0.1M. (1/[A] - 1/[A]₀ = kt)", textHi: "एक द्वितीय-कोटि अभिक्रिया के लिए, [A]₀ = 0.5M, k = 0.2 L/mol.min है। वह समय t (मिनट में) ज्ञात करें जब [A] = 0.1M हो।", ans: "40" }
];

const mathQuestions_4: any[] = [
    { type: 'MCQ', textEn: "If ∫₀ᵃ f(x)dx = ∫₀ᵃ f(a-x)dx, then what is ∫₀ᵃ x f(x)dx equal to?", textHi: "यदि ∫₀ᵃ f(x)dx = ∫₀ᵃ f(a-x)dx है, तो ∫₀ᵃ x f(x)dx किसके बराबर है?", options: [{en: "(a/2) ∫₀ᵃ f(x)dx", hi: "(a/2) ∫₀ᵃ f(x)dx"}, {en: "a ∫₀ᵃ f(x)dx", hi: "a ∫₀ᵃ f(x)dx"}, {en: "(a²/2) f(a/2)", hi: "(a²/2) f(a/2)"}, {en: "None of these", hi: "इनमें से कोई नहीं"}], ans: 1 },
    { type: 'MCQ', textEn: "The equation of the tangent to the parabola y² = 4ax at the point (at², 2at) is:", textHi: "बिंदु (at², 2at) पर परवलय y² = 4ax की स्पर्शरेखा का समीकरण है:", options: [{en: "ty = x + at²", hi: "ty = x + at²"}, {en: "tx = y + at²", hi: "tx = y + at²"}, {en: "y = tx + a/t", hi: "y = tx + a/t"}, {en: "x = ty + 2at", hi: "x = ty + 2at"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The local maximum of f(x) = x³ - 3x occurs at:", textHi: "f(x) = x³ - 3x का स्थानीय उच्चतम (local maximum) किस पर होता है?", options: [{en: "x = -1", hi: "x = -1"}, {en: "x = 1", hi: "x = 1"}, {en: "x = 0", hi: "x = 0"}, {en: "Both x = 1 and x = -1", hi: "x = 1 और x = -1 दोनों"}], ans: 1 },
    { type: 'MCQ', textEn: "What is the equation of the director circle of the ellipse x²/16 + y²/9 = 1?", textHi: "दीर्घवृत्त x²/16 + y²/9 = 1 के नियामक वृत्त (director circle) का समीकरण क्या है?", options: [{en: "x² + y² = 25", hi: "x² + y² = 25"}, {en: "x² + y² = 7", hi: "x² + y² = 7"}, {en: "x² + y² = 144", hi: "x² + y² = 144"}, {en: "No director circle exists", hi: "कोई नियामक वृत्त नहीं होता"}], ans: 1 },
    { type: 'MCQ', textEn: "The asymptotes of the rectangular hyperbola x²/4 - y²/4 = 1 are:", textHi: "समकोणीय अतिपरवलय (rectangular hyperbola) x²/4 - y²/4 = 1 के अनंतस्पर्शी (asymptotes) हैं:", options: [{en: "y = ±x", hi: "y = ±x"}, {en: "y = ±2x", hi: "y = ±2x"}, {en: "y = ±x/2", hi: "y = ±x/2"}, {en: "y = ±√2 x", hi: "y = ±√2 x"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "lim(x→0) (e^x - 1 - x) / x² = ?", textHi: "lim(x→0) (e^x - 1 - x) / x² = ?", options: [{en: "1/2", hi: "1/2"}, {en: "1", hi: "1"}, {en: "0", hi: "0"}, {en: "∞", hi: "∞"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "Which of the following is a true trigonometric identity?", textHi: "निम्नलिखित में से कौन सी त्रिकोणमितीय सर्वसमिका सत्य है?", options: [{en: "cos(3θ) = 4cos³θ - 3cosθ", hi: "cos(3θ) = 4cos³θ - 3cosθ"}, {en: "cos(3θ) = 3cosθ - 4cos³θ", hi: "cos(3θ) = 3cosθ - 4cos³θ"}, {en: "sin(3θ) = 4sin³θ - 3sinθ", hi: "sin(3θ) = 4sin³θ - 3sinθ"}, {en: "Both A and C", hi: "A और C दोनों"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "If ω is a complex cube root of unity, then 1 + ω + ω² = ?", textHi: "यदि ω इकाई का एक सम्मिश्र घनमूल (cube root of unity) है, तो 1 + ω + ω² = ?", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "-1", hi: "-1"}, {en: "3", hi: "3"}], ans: 1 },
    { type: 'MCQ', textEn: "If roots α, β satisfy α + β = 3 and αβ = 2, find the value of α² + β².", textHi: "यदि मूल α, β शर्त α + β = 3 और αβ = 2 को संतुष्ट करते हैं, तो α² + β² का मान ज्ञात करें।", options: [{en: "5", hi: "5"}, {en: "7", hi: "7"}, {en: "1", hi: "1"}, {en: "6", hi: "6"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The integrating factor for the differential equation dy/dx + y(tanx) = sin²x is:", textHi: "अवकल समीकरण dy/dx + y(tanx) = sin²x के लिए समाकलन गुणक (Integrating Factor) है:", options: [{en: "sec x", hi: "sec x"}, {en: "cos x", hi: "cos x"}, {en: "sin x", hi: "sin x"}, {en: "tan x", hi: "tan x"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "Calculate the area enclosed by the ellipse x²/25 + y²/16 ≤ 1. (Divide your answer by π and enter the integer).", textHi: "दीर्घवृत्त x²/25 + y²/16 ≤ 1 द्वारा घिरे क्षेत्र के क्षेत्रफल की गणना करें। (अपने उत्तर को π से विभाजित करें और पूर्णांक दर्ज करें)।", ans: "20" },
    ...
    { type: 'Numerical', textEn: "Evaluate ∫₀¹ (x eˣ) dx.", textHi: "मान ज्ञात करें: ∫₀¹ (x eˣ) dx.", ans: "1" },
    { type: 'Numerical', textEn: "For a 2x2 matrix A, if trace(A) = 3 and det(A) = 2, find the trace of A².", textHi: "एक 2x2 आव्यूह A के लिए, यदि trace(A) = 3 और det(A) = 2 है, तो A² का trace ज्ञात करें।", ans: "5" },
