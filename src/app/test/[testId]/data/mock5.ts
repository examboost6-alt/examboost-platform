...
const mathQuestions_5: any[] = [
    { type: 'MCQ', textEn: "lim(x→0) [(sinx - x)/x³] = ?", textHi: "lim(x→0) [(sinx - x)/x³] = ?", options: [{en: "0", hi: "0"}, {en: "-1/6", hi: "-1/6"}, {en: "1/6", hi: "1/6"}, {en: "-1/3", hi: "-1/3"}], ans: 2 },
    { type: 'MCQ', textEn: "f(x) = (x² - 1)/(x - 1), x ≠ 1; f(1) = k. For continuity at x = 1, what is k?", textHi: "f(x) = (x² - 1)/(x - 1), x ≠ 1; f(1) = k. x = 1 पर सांतत्य (continuity) के लिए k क्या है?", options: [{en: "1", hi: "1"}, {en: "2", hi: "2"}, {en: "-2", hi: "-2"}, {en: "0", hi: "0"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "Find the local maxima point of f(x) = x³ - 3x² + 2.", textHi: "f(x) = x³ - 3x² + 2 का स्थानीय उच्चिष्ठ (local maxima) बिंदु ज्ञात करें।", options: [{en: "x = 0", hi: "x = 0"}, {en: "x = 2", hi: "x = 2"}, {en: "x = 1", hi: "x = 1"}, {en: "x = 3", hi: "x = 3"}], ans: 1 },
    { type: 'MCQ', textEn: "∫ (1/(1+x²)) dx = ?", textHi: "∫ (1/(1+x²)) dx = ?", options: [{en: "ln x + C", hi: "ln x + C"}, {en: "tan⁻¹x + C", hi: "tan⁻¹x + C"}, {en: "e^x + C", hi: "e^x + C"}, {en: "sin⁻¹x + C", hi: "sin⁻¹x + C"}], ans: 2 },
    { type: 'MCQ', textEn: "∫₀^π sinx dx = ?", textHi: "∫₀^π sinx dx = ?", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "2", hi: "2"}, {en: "π", hi: "π"}], ans: 3 },
    { type: 'MCQ', textEn: "The solution to the differential equation dy/dx = y is:", textHi: "अवकल समीकरण dy/dx = y का हल है:", options: [{en: "y = x + C", hi: "y = x + C"}, {en: "y = C e^x", hi: "y = C e^x"}, {en: "y = ln x + C", hi: "y = ln x + C"}, {en: "y = x² + C", hi: "y = x² + C"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "What is the coefficient of x² in the expansion of (1 + x)⁵?", textHi: "(1 + x)⁵ के प्रसार में x² का गुणांक क्या है?", options: [{en: "5", hi: "5"}, {en: "10", hi: "10"}, {en: "20", hi: "20"}, {en: "15", hi: "15"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The radius of the circle x² + y² = 9 is:", textHi: "वृत्त x² + y² = 9 की त्रिज्या है:", options: [{en: "9", hi: "9"}, {en: "3", hi: "3"}, {en: "81", hi: "81"}, {en: "√3", hi: "√3"}], ans: 2 },
    { type: 'MCQ', textEn: "sin²x + cos²x = ?", textHi: "sin²x + cos²x = ?", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "-1", hi: "-1"}, {en: "2", hi: "2"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "log₁₀(1000) = ?", textHi: "log₁₀(1000) = ?", options: [{en: "10", hi: "10"}, {en: "100", hi: "100"}, {en: "3", hi: "3"}, {en: "1", hi: "1"}], ans: 3 },
    { type: 'Numerical', textEn: "lim(x→∞) (x/(x+1)) = ?", textHi: "lim(x→∞) (x/(x+1)) = ?", ans: "1" },
    { type: 'Numerical', textEn: "The value of ∫₀¹ x dx is: (in decimals)", textHi: "∫₀¹ x dx का मान है: (दशमलव में)", ans: "0.5" },
