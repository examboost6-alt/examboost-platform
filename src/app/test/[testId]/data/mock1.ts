...
const physicsQuestions_1: any[] = [
    ...
    { type: 'MCQ', textEn: "The dimensional formula of force is:", textHi: "बल का विमीय सूत्र है:", options: [{en: "MLT^-¹", hi: "MLT^-¹"}, {en: "ML^2T^-^2", hi: "ML^2T^-^2"}, {en: "MLT^-^2", hi: "MLT^-^2"}, {en: "MLT^-^3", hi: "MLT^-^3"}], ans: 3 },
    ...
    { type: 'MCQ', textEn: "The formula for Torque is:", textHi: "बल आघूर्ण (Torque) का सूत्र है:", options: [{en: "F x r", hi: "F x r"}, {en: "r x F", hi: "r x F"}, {en: "p x E", hi: "p x E"}, {en: "m x v", hi: "m x v"}], ans: 2 },
    ...
    { type: 'Numerical', textEn: "If acceleration is 2 m/s^2 and time is 5s (starting from rest), what is the final velocity?", textHi: "यदि त्वरण 2 m/s^2 है और समय 5s है (विराम से शुरू), तो अंतिम वेग क्या है?", ans: "10" },
    ...
    { type: 'Numerical', textEn: "If g = 10 m/s^2 at the surface, what is the value of g at a height equal to the radius of the Earth? (in m/s^2)", textHi: "यदि पृथ्वी की सतह पर g = 10 m/s^2 है, तो पृथ्वी की त्रिज्या के बराबर ऊंचाई पर g का मान क्या है? (m/s^2 में)", ans: "2.5" }
];

const chemistryQuestions_1: any[] = [
    { type: 'MCQ', textEn: "The central atom in IF_5 has:", textHi: "IF_5 में केंद्रीय परमाणु में क्या होता है?", options: [{en: "Square pyramidal shape, 1 lone pair", hi: "वर्ग पिरामिडीय आकार, 1 एकाकी युग्म"}, {en: "Trigonal bipyramidal, 2 lone pairs", hi: "त्रिकोणीय द्विपिरामिडीय, 2 एकाकी युग्म"}, {en: "Square pyramidal, 1 lone pair", hi: "वर्ग पिरामिडीय, 1 एकाकी युग्म"}, {en: "Octahedral, 0 lone pairs", hi: "अष्टफलकीय, 0 एकाकी युग्म"}], ans: 3 },
    { type: 'MCQ', textEn: "[Co(NH_3)_5Cl]SO_4 and [Co(NH_3)_5SO_4]Cl are:", textHi: "[Co(NH_3)_5Cl]SO_4 और [Co(NH_3)_5SO_4]Cl क्या हैं?", options: [{en: "Coordination isomers", hi: "उपसहसंयोजन समावयवी"}, {en: "Ionization isomers", hi: "आयनन समावयवी"}, {en: "Geometrical isomers", hi: "ज्यामितीय समावयवी"}, {en: "Linkage isomers", hi: "बंधन समावयवी"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "For 2SO_2 + O_2 ⇌ 2SO_3, Kp/Kc =", textHi: "2SO_2 + O_2 ⇌ 2SO_3 के लिए, Kp/Kc =", options: [{en: "RT^{-1/2}", hi: "RT^{-1/2}"}, {en: "RT^{1/2}", hi: "RT^{1/2}"}, {en: "RT", hi: "RT"}, {en: "1", hi: "1"}], ans: 1 },
    { type: 'MCQ', textEn: "Equivalent weight of KMnO_4 in acidic medium = M/", textHi: "अम्लीय माध्यम में KMnO_4 का तुल्यांकी भार = M/", options: [{en: "5", hi: "5"}, {en: "3", hi: "3"}, {en: "1", hi: "1"}, {en: "6", hi: "6"}], ans: 1 },
    { type: 'MCQ', textEn: "Benzene + CH_3Cl/AlCl_3 → Toluene. Next Cl_2/FeCl_3 → major product?", textHi: "बेंजीन + CH_3Cl/AlCl_3 → टॉलूईन। इसके बाद Cl_2/FeCl_3 के साथ अभिक्रिया का मुख्य उत्पाद क्या होगा?", options: [{en: "o/p-chlorotoluene", hi: "ऑर्थो/पैरा-क्लोरोटॉलूईन"}, {en: "m-chlorotoluene", hi: "मेटा-क्लोरोटॉलूईन"}, {en: "1,3-dichlorobenzene", hi: "1,3-डाइक्लोरोबेंजीन"}, {en: "Benzyl chloride", hi: "बेंजाइल क्लोराइड"}], ans: 1 },
    { type: 'MCQ', textEn: "In [Ni(CN)_4]^2^-, Ni is:", textHi: "[Ni(CN)_4]^2^- में, Ni कैसा है?", options: [{en: "sp^3, paramagnetic", hi: "sp^3, अनुचुंबकीय"}, {en: "dsp^2, diamagnetic", hi: "dsp^2, प्रतिचुंबकीय"}, {en: "dsp^2, paramagnetic", hi: "dsp^2, अनुचुंबकीय"}, {en: "sp^3, diamagnetic", hi: "sp^3, प्रतिचुंबकीय"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "CH_3CH_2Br + alc. KOH → major?", textHi: "CH_3CH_2Br + एल्कोहोलिक KOH → मुख्य उत्पाद?", options: [{en: "CH_2=CH_2", hi: "CH_2=CH_2"}, {en: "CH_3CH_2OH", hi: "CH_3CH_2OH"}, {en: "CH_3CHO", hi: "CH_3CHO"}, {en: "CH_3CH_3", hi: "CH_3CH_3"}], ans: 1 },
    { type: 'MCQ', textEn: "Which has highest +I effect?", textHi: "किसमें सर्वाधिक +I प्रभाव होता है?", options: [{en: "-NH_2", hi: "-NH_2"}, {en: "-OH", hi: "-OH"}, {en: "-CH_3", hi: "-CH_3"}, {en: "-OR", hi: "-OR"}], ans: 3 },
    ...
    { type: 'MCQ', textEn: "Order of acidity: HF > H_2O > NH_3 > CH_4 Reason:", textHi: "अम्लता का क्रम: HF > H_2O > NH_3 > CH_4 इसका कारण है:", options: [{en: "Bond strength", hi: "आबंध सामर्थ्य"}, {en: "Electronegativity", hi: "विद्युतऋणात्मकता"}, {en: "Size", hi: "आकार"}, {en: "Resonance", hi: "अनुनाद"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "For zero order, t1/2 ∝", textHi: "शून्य कोटि (zero order) अभिक्रिया के लिए, t1/2 ∝", options: [{en: "[A]⁰", hi: "[A]⁰"}, {en: "[A]", hi: "[A]"}, {en: "1/[A]", hi: "1/[A]"}, {en: "1/[A]^2", hi: "1/[A]^2"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "Colour in KMnO_4 due to:", textHi: "KMnO_4 में रंग किसके कारण होता है?", options: [{en: "d-d transition", hi: "d-d संक्रमण"}, {en: "Charge transfer", hi: "आवेश स्थानांतरण"}, {en: "f-f", hi: "f-f संक्रमण"}, {en: "LMCT", hi: "LMCT"}], ans: 2 },
    ...
    { type: 'Numerical', textEn: "6.023x10^2^3 molecules of N_2 occupy 11.2 L at STP. Volume of 34g NH_3 at STP?", textHi: "N_2 के 6.023x10^2^3 अणु STP पर 11.2 L स्थान घेरते हैं। STP पर 34g NH_3 का आयतन क्या होगा?", ans: "44.8" },
    { type: 'Numerical', textEn: "For 2HI ⇌ H_2 + I_2, Kc=0.02 at 500K. If [HI]_0=4M, equilibrium [H_2]?", textHi: "500K पर 2HI ⇌ H_2 + I_2, Kc=0.02 के लिए। यदि [HI]_0=4M है, तो साम्यावस्था में [H_2] क्या होगा?", ans: "0.4" },
    { type: 'Numerical', textEn: "For Zn | Zn^2^+(0.1M) || Cu^2^+(1M) | Cu, E_cell if E°=1.1V. (RT/F=0.06)", textHi: "Zn | Zn^2^+(0.1M) || Cu^2^+(1M) | Cu के लिए, E_cell का मान यदि E°=1.1V है। (RT/F=0.06)", ans: "1.14" },
    ...
    { type: 'Numerical', textEn: "t1/2=10 min for first order. Time for 75% decomposition?", textHi: "प्रथम कोटि अभिक्रिया के लिए t1/2=10 मिनट। 75% वियोजन के लिए कितना समय लगेगा?", ans: "20" }
];
...
const mathQuestions_1: any[] = [
    ...
    { type: 'MCQ', textEn: "If the roots of x^2 - px + q = 0 differ by unity, then p^2 - 4q is:", textHi: "यदि समीकरण x^2 - px + q = 0 के मूलों का अंतर 1 है, तो p^2 - 4q का मान है:", options: [{en: "1", hi: "1"}, {en: "2", hi: "2"}, {en: "p", hi: "p"}, {en: "q", hi: "q"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "∫ dx / [cos^2x (1 + tanx)^2] =", textHi: "∫ dx / [cos^2x (1 + tanx)^2] का मान है:", options: [{en: "-1/(1+tanx) + C", hi: "-1/(1+tanx) + C"}, {en: "ln|1+tanx| + C", hi: "ln|1+tanx| + C"}, {en: "1/(1+tanx) + C", hi: "1/(1+tanx) + C"}, {en: "tanx + C", hi: "tanx + C"}], ans: 1 },
    { type: 'MCQ', textEn: "∫(-1 to 1) |x| dx =", textHi: "∫(-1 से 1) |x| dx का मान है:", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "2", hi: "2"}, {en: "1/2", hi: "1/2"}], ans: 2 },
    { type: 'MCQ', textEn: "Degree of (1 + (dy/dx)^2)^(3/2) = d^2y/dx^2:", textHi: "अवकल समीकरण (1 + (dy/dx)^2)^(3/2) = d^2y/dx^2 की घात (Degree) है:", options: [{en: "1", hi: "1"}, {en: "2", hi: "2"}, {en: "3", hi: "3"}, {en: "Not defined", hi: "परिभाषित नहीं"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "If line 3x + 4y = k touches circle x^2 + y^2 = 25, then k is:", textHi: "यदि रेखा 3x + 4y = k वृत्त x^2 + y^2 = 25 को स्पर्श करती है, तो k का मान है:", options: [{en: "5", hi: "5"}, {en: "10", hi: "10"}, {en: "±25", hi: "±25"}, {en: "±5", hi: "±5"}], ans: 3 },
    { type: 'MCQ', textEn: "Eccentricity of hyperbola x^2 - y^2 = 9:", textHi: "अतिपरवलय (hyperbola) x^2 - y^2 = 9 की उत्केंद्रता (Eccentricity) है:", options: [{en: "1", hi: "1"}, {en: "√2", hi: "√2"}, {en: "2", hi: "2"}, {en: "√3", hi: "√3"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "Mean of ax_1+b, ax_2+b,..., axₙ+b:", textHi: "अवलोकनों ax_1+b, ax_2+b,..., axₙ+b का माध्य है:", options: [{en: "a x̄ + b", hi: "a x̄ + b"}, {en: "x̄ + b", hi: "x̄ + b"}, {en: "a x̄", hi: "a x̄"}, {en: "x̄", hi: "x̄"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "Term independent of x in (x^2 + 1/x)^6:", textHi: "(x^2 + 1/x)^6 के प्रसार में x से स्वतंत्र पद है:", ans: "15" },
    { type: 'Numerical', textEn: "Area between y = x^2 and y = x:", textHi: "वक्र y = x^2 और रेखा y = x द्वारा घिरे क्षेत्र का क्षेत्रफल है:", ans: "0.167" },
    ...
    { type: 'Numerical', textEn: "f(x) = x^3 - 3x^2 + 6x + 7. Number of local extrema:", textHi: "f(x) = x^3 - 3x^2 + 6x + 7 के स्थानीय चरम बिंदुओं (local extrema) की संख्या है:", ans: "0" }
];
