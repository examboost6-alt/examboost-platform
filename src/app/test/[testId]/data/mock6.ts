...
const physicsQuestions_6: any[] = [
    ...
    { type: 'MCQ', textEn: "The momentum of a photon is given by?", textHi: "फोटॉन का संवेग (momentum) किसके द्वारा दिया जाता है?", options: [{en: "mc", hi: "mc"}, {en: "h/λ", hi: "h/λ"}, {en: "λ/h", hi: "λ/h"}, {en: "hν", hi: "hν"}], ans: 2 },
