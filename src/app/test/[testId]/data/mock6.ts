...
const physicsQuestions_6: any[] = [
    { type: 'MCQ', textEn: "Electric potential due to a point charge varies as?", textHi: "एक बिंदु आवेश के कारण विद्युत विभव (electric potential) कैसे परिवर्तित होता है?", options: [{en: "r", hi: "r"}, {en: "1/r", hi: "1/r"}, {en: "1/r^2", hi: "1/r^2"}, {en: "r^2", hi: "r^2"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "Force on a current carrying wire in a uniform magnetic field is:", textHi: "एकसमान चुंबकीय क्षेत्र में धारावाही चालक तार पर लगने वाला बल है:", options: [{en: "qvB", hi: "qvB"}, {en: "BIL (or ILxB)", hi: "BIL (या ILxB)"}, {en: "qE", hi: "qE"}, {en: "mv^2/r", hi: "mv^2/r"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The intensity of a wave is proportional to:", textHi: "एक तरंग की तीव्रता (Intensity) किसके अनुक्रमानुपाती होती है?", options: [{en: "Amplitude (A)", hi: "आयाम (A)"}, {en: "Amplitude squared (A^2)", hi: "आयाम का वर्ग (A^2)"}, {en: "1/A", hi: "1/A"}, {en: "Wavelength (λ)", hi: "तरंगदैर्ध्य (λ)"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "Acceleration due to gravity (g) varies with distance R from the center of the earth (for R > Re) as:", textHi: "पृथ्वी के केंद्र से दूरी R के साथ गुरुत्वाकर्षण त्वरण (g) कैसे बदलता है (R > Re के लिए)?", options: [{en: "R", hi: "R"}, {en: "1/R^2", hi: "1/R^2"}, {en: "R^2", hi: "R^2"}, {en: "Constant", hi: "स्थिर"}], ans: 2 },
    { type: 'MCQ', textEn: "The time period of a spring-mass system is proportional to:", textHi: "स्प्रिंग-द्रव्यमान निकाय का आवर्तकाल (Time period) किसके अनुक्रमानुपाती होता है?", options: [{en: "√m", hi: "√m"}, {en: "m", hi: "m"}, {en: "1/m", hi: "1/m"}, {en: "m^2", hi: "m^2"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The formula for Pressure is:", textHi: "दाब (Pressure) का सूत्र है:", options: [{en: "Force x Area", hi: "बल x क्षेत्रफल"}, {en: "Force / Area", hi: "बल / क्षेत्रफल"}, {en: "Area / Force", hi: "क्षेत्रफल / बल"}, {en: "Force + Area", hi: "बल + क्षेत्रफल"}], ans: 2 },
    { type: 'MCQ', textEn: "The SI unit of acceleration is:", textHi: "त्वरण (Acceleration) की SI इकाई है:", options: [{en: "m/s", hi: "m/s"}, {en: "m/s^2", hi: "m/s^2"}, {en: "m^2/s", hi: "m^2/s"}, {en: "km/h", hi: "km/h"}], ans: 2 },
    { type: 'MCQ', textEn: "The fundamental formula for Work done is:", textHi: "किए गए कार्य (Work done) का मूल सूत्र है:", options: [{en: "Mass x Velocity", hi: "द्रव्यमान x वेग"}, {en: "Force x Displacement", hi: "बल x विस्थापन"}, {en: "Power x Area", hi: "शक्ति x क्षेत्रफल"}, {en: "Force / Area", hi: "बल / क्षेत्रफल"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The formula for linear momentum is:", textHi: "रेखीय संवेग (Linear momentum) का सूत्र है:", options: [{en: "mv^2", hi: "mv^2"}, {en: "mv", hi: "mv"}, {en: "ma", hi: "ma"}, {en: "m/v", hi: "m/v"}], ans: 2 },
...
const chemistryQuestions_6: any[] = [
    ...
    { type: 'MCQ', textEn: "Ammonia (NH_3) acts as a Lewis base primarily due to the presence of:", textHi: "अमोनिया (NH_3) मुख्य रूप से किसकी उपस्थिति के कारण एक लुईस क्षार के रूप में कार्य करता है?", options: [{en: "A lone pair of electrons", hi: "इलेक्ट्रॉनों के एकाकी युग्म (lone pair)"}, {en: "Covalent bonds", hi: "सहसंयोजक आबंध"}, {en: "Partial positive charge", hi: "आंशिक धनात्मक आवेश"}, {en: "None of these", hi: "इनमें से कोई नहीं"}], ans: 1 },
    { type: 'MCQ', textEn: "Is the Fe^2^+ ion paramagnetic in nature?", textHi: "क्या Fe^2^+ आयन प्रकृति में अनुचुंबकीय है?", options: [{en: "Yes", hi: "हाँ"}, {en: "No (It is diamagnetic)", hi: "नहीं (प्रतिचुंबकीय है)"}, {en: "It is neutral", hi: "यह उदासीन है"}, {en: "None of these", hi: "इनमें से कोई नहीं"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "What is the approximate value of Avogadro's number?", textHi: "अवोगाद्रो संख्या (Avogadro's number) का अनुमानित मान क्या है?", options: [{en: "6.022 x 10^2^3", hi: "6.022 x 10^2^3"}, {en: "6.022 x 10^-^2^3", hi: "6.022 x 10^-^2^3"}, {en: "1.602 x 10^-¹⁹", hi: "1.602 x 10^-¹⁹"}, {en: "9.11 x 10^-^3¹", hi: "9.11 x 10^-^3¹"}], ans: 1 },
    { type: 'MCQ', textEn: "The formula used to calculate pH is:", textHi: "pH की गणना करने के लिए प्रयुक्त सूत्र है:", options: [{en: "-log_1_0[H^+]", hi: "-log_1_0[H^+]"}, {en: "log_1_0[H^+]", hi: "log_1_0[H^+]"}, {en: "-ln[H^+]", hi: "-ln[H^+]"}, {en: "[H^+]^2", hi: "[H^+]^2"}], ans: 1 },
    { type: 'MCQ', textEn: "What is the hybridization of the carbon atom in a methane (CH_4) molecule?", textHi: "मीथेन (CH_4) अणु में कार्बन परमाणु का संकरण क्या है?", options: [{en: "sp", hi: "sp"}, {en: "sp^2", hi: "sp^2"}, {en: "sp^3", hi: "sp^3"}, {en: "dsp^2", hi: "dsp^2"}], ans: 3 },
    { type: 'MCQ', textEn: "The expected H-C-H bond angle in a molecule of CH_4 is:", textHi: "CH_4 के एक अणु में अपेक्षित H-C-H आबंध कोण है:", options: [{en: "90°", hi: "90°"}, {en: "109.5°", hi: "109.5°"}, {en: "120°", hi: "120°"}, {en: "180°", hi: "180°"}], ans: 2 },
    ...
    { type: 'Numerical', textEn: "What is the molar mass of Carbon Dioxide (CO_2) in g/mol?", textHi: "कार्बन डाइऑक्साइड (CO_2) का मोलर द्रव्यमान (g/mol में) क्या है?", ans: "44" }
];
...
const mathQuestions_6: any[] = [
    ...
    { type: 'MCQ', textEn: "For any real number x, the value of sin^2x + cos^2x is:", textHi: "किसी भी वास्तविक संख्या x के लिए, sin^2x + cos^2x का मान है:", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "2", hi: "2"}, {en: "-1", hi: "-1"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The value of log_1_0(10) is:", textHi: "log_1_0(10) का मान है:", options: [{en: "1", hi: "1"}, {en: "0", hi: "0"}, {en: "10", hi: "10"}, {en: "-1", hi: "-1"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The derivative of x^2 with respect to x is:", textHi: "x के सापेक्ष x^2 का अवकलज है:", options: [{en: "2x", hi: "2x"}, {en: "x", hi: "x"}, {en: "x^2/2", hi: "x^2/2"}, {en: "2", hi: "2"}], ans: 1 },
    { type: 'MCQ', textEn: "The indefinite integral ∫ 1 dx is:", textHi: "अनिश्चित समाकलन ∫ 1 dx है:", options: [{en: "x + C", hi: "x + C"}, {en: "1 + C", hi: "1 + C"}, {en: "x^2 + C", hi: "x^2 + C"}, {en: "0", hi: "0"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "Evaluate the definite integral ∫_0¹ x^2 dx. (Enter the decimal value like 0.33)", textHi: "निश्चित समाकलन ∫_0¹ x^2 dx का मान ज्ञात करें। (दशमलव अंश दर्ज करें)", ans: "0.33" },
    { type: 'Numerical', textEn: "Find the value of the derivative d/dx(x^3) at x = 1.", textHi: "x = 1 पर अवकलज d/dx(x^3) का मान ज्ञात करें।", ans: "3" },
