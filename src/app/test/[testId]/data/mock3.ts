...
const mathQuestions_3: any[] = [
    ...
    { type: 'MCQ', textEn: "If P(A|B)=2/3, P(B|A)=3/5, and P(A)=1/2, find P(B).", textHi: "यदि P(A|B)=2/3, P(B|A)=3/5, और P(A)=1/2 है, तो P(B) ज्ञात करें।", options: [{en: "3/7", hi: "3/7 (Wait, P(A∩B)=3/10 so P(B)=9/20?)", hi: "9/20"}, {en: "9/20", hi: "9/20"}, {en: "1/3", hi: "1/3"}, {en: "4/7", hi: "4/7"}], ans: 2 },
