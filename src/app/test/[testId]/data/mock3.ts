...
const physicsQuestions_3: any[] = [
    { type: 'MCQ', textEn: "The position function of a particle is x = t^3 - 3t^2 + 2t. What will be the acceleration at t = 1 s?", textHi: "एक कण का स्थिति फलन x = t^3 - 3t^2 + 2t है। t = 1 s पर त्वरण क्या होगा?", options: [{en: "0", hi: "0"}, {en: "2", hi: "2"}, {en: "-2", hi: "-2"}, {en: "6", hi: "6"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "What is the SI unit of electric flux?", textHi: "विद्युत फ्लक्स की SI इकाई क्या है?", options: [{en: "N C/m^2", hi: "N C/m^2"}, {en: "N m^2/C", hi: "N m^2/C"}, {en: "V/m", hi: "V/m"}, {en: "J/C", hi: "J/C"}], ans: 2 },
    ...
    { type: 'Numerical', textEn: "If x = t^2 + 2t + 1, what will be the velocity at t = 2s?", textHi: "यदि x = t^2 + 2t + 1 है, तो t = 2s पर वेग क्या होगा?", ans: "6" },
    ...
    { type: 'Numerical', textEn: "A body is thrown upwards with a velocity of 10 m/s. (Take g = 10 m/s^2). What will be the maximum height?", textHi: "एक पिंड को 10 m/s के वेग से ऊपर की ओर फेंका गया। (g = 10 m/s^2 लें)। अधिकतम ऊंचाई (मीटर में) क्या होगी?", ans: "5" },
...
const chemistryQuestions_3: any[] = [
    { type: 'MCQ', textEn: "Solubility order of alkaline earth metal sulphates in water:", textHi: "क्षारीय मृदा धातु सल्फेटों की जल में विलेयता का क्रम है:", options: [{en: "BeSO_4 > MgSO_4 > CaSO_4 > SrSO_4 > BaSO_4", hi: "BeSO_4 > MgSO_4 > CaSO_4 > SrSO_4 > BaSO_4"}, {en: "BaSO_4 > SrSO_4 > CaSO_4 > MgSO_4 > BeSO_4", hi: "BaSO_4 > SrSO_4 > CaSO_4 > MgSO_4 > BeSO_4"}, {en: "MgSO_4 > BeSO_4 > CaSO_4 > SrSO_4 > BaSO_4", hi: "MgSO_4 > BeSO_4 > CaSO_4 > SrSO_4 > BaSO_4"}, {en: "CaSO_4 > SrSO_4 > BaSO_4 > MgSO_4 > BeSO_4", hi: "CaSO_4 > SrSO_4 > BaSO_4 > MgSO_4 > BeSO_4"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "Classical smog contains:", textHi: "पुराने (Classical) स्मॉग में होता है:", options: [{en: "SO_2/H_2SO_4 aerosol", hi: "SO_2/H_2SO_4 एरोसोल"}, {en: "NOx", hi: "NOx"}, {en: "O_3", hi: "O_3"}, {en: "PAN", hi: "PAN"}], ans: 1 },
    { type: 'MCQ', textEn: "Which carbocation is more stable: (CH_3)_2CH^+ or CH_3CH_2CH_2^+?", textHi: "कौन सा कार्बोकैटायन अधिक स्थिर है: (CH_3)_2CH^+ या CH_3CH_2CH_2^+?", options: [{en: "Isopropyl ((CH_3)_2CH^+)", hi: "आइसोप्रोपाइल ((CH_3)_2CH^+)"}, {en: "n-propyl (CH_3CH_2CH_2^+)", hi: "n-प्रोपाइल (CH_3CH_2CH_2^+)"}, {en: "Both are equally stable", hi: "दोनो समान रूप से स्थिर हैं"}, {en: "Cannot be determined", hi: "निर्धारित नहीं किया जा सकता"}], ans: 1 },
    { type: 'MCQ', textEn: "Ozonolysis of CH_3CH=CHCH_3 followed by Zn/H_2O gives:", textHi: "CH_3CH=CHCH_3 का ओजोनोलिसिस Zn/H_2O की उपस्थिति में करने पर क्या मिलता है?", options: [{en: "2 CH_3CHO", hi: "2 CH_3CHO"}, {en: "CH_3COCH_3", hi: "CH_3COCH_3"}, {en: "CH_3CH_2CHO", hi: "CH_3CH_2CHO"}, {en: "HCHO + CH_3COCH_3", hi: "HCHO + CH_3COCH_3"}], ans: 1 },
    { type: 'MCQ', textEn: "C_6H_5Cl + NaOH at 623K gives:", textHi: "623K ताप पर C_6H_5Cl + NaOH देता है:", options: [{en: "No reaction", hi: "कोई प्रतिक्रिया नहीं"}, {en: "C_6H_5OH (Phenol)", hi: "C_6H_5OH (फिनॉल)"}, {en: "C_6H_5ONa", hi: "C_6H_5ONa"}, {en: "C_6H_6 (Benzene)", hi: "C_6H_6 (बेंजीन)"}], ans: 2 },
    { type: 'MCQ', textEn: "(CH_3)_3COH + Lucas reagent → ?", textHi: "(CH_3)_3COH + लुकास अभिकर्मक → ?", options: [{en: "No reaction", hi: "कोई प्रतिक्रिया नहीं"}, {en: "Turbidity appears instantly", hi: "तुरंत धुंधलापन (Turbidity) आता है"}, {en: "Turbidity after 5 minutes", hi: "5 मिनट बाद धुंधलापन"}, {en: "Turbidity after 10 minutes", hi: "10 मिनट बाद धुंधलापन"}], ans: 2 },
    { type: 'MCQ', textEn: "CH_3CH_2Br + CH_3ONa → ? (Major Product)", textHi: "CH_3CH_2Br + CH_3ONa → ? (मुख्य उत्पाद)", options: [{en: "CH_3CH_2OCH_3", hi: "CH_3CH_2OCH_3"}, {en: "CH_3CH_2OCH_2CH_3", hi: "CH_3CH_2OCH_2CH_3"}, {en: "CH_3OCH_3", hi: "CH_3OCH_3"}, {en: "Elimination product", hi: "विलोपन उत्पाद"}], ans: 1 },
    { type: 'MCQ', textEn: "Self aldol condensation of CH_3CHO yields:", textHi: "CH_3CHO का स्व-एल्डोल संघनन क्या देता है?", options: [{en: "Aldol and crotonaldehyde (depending on temp)", hi: "एल्डोल और क्रोटोनलडिहाइड (तापमान पर निर्भर)"}, {en: "Only aldol", hi: "केवल एल्डोल"}, {en: "Only crotonaldehyde", hi: "केवल क्रोटोनलडिहाइड"}, {en: "No aldol formed", hi: "कोई एल्डोल नहीं बनता"}], ans: 1 },
    { type: 'MCQ', textEn: "C_6H_5NH_2 reacts with Hinsberg's reagent to form a product which is:", textHi: "C_6H_5NH_2 हिन्सबर्ग अभिकर्मक के साथ प्रतिक्रिया करके जो उत्पाद बनाता है, वह है:", options: [{en: "Soluble in alkali", hi: "क्षार में विलेय"}, {en: "Insoluble in both acid and alkali", hi: "अम्ल और क्षार दोनों में अविलेय"}, {en: "Soluble in both", hi: "दोनों में विलेय"}, {en: "Soluble in acid", hi: "अम्ल में विलेय"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "IUPAC name of CH_3CH(CH_3)CH_2CH(CH_2CH_3)CH_2CH_3:", textHi: "CH_3CH(CH_3)CH_2CH(CH_2CH_3)CH_2CH_3 का IUPAC नाम है:", options: [{en: "3-ethyl-2-methylhexane", hi: "3-एथिल-2-मिथाइलहेक्सेन"}, {en: "4-ethyl-5-methylhexane", hi: "4-एथिल-5-मिथाइलहेक्सेन"}, {en: "3-ethyl-4-methylhexane", hi: "3-एथिल-4-मिथाइलहेक्सेन"}, {en: "2-methyl-3-ethylhexane", hi: "2-मिथाइल-3-एथिलहेक्सेन"}], ans: 1 },
    { type: 'MCQ', textEn: "The number of unpaired electrons in [Fe(H_2O)_6]^2^+ is:", textHi: "[Fe(H_2O)_6]^2^+ में अयुग्मित इलेक्ट्रॉनों (unpaired electrons) की संख्या है:", options: [{en: "4", hi: "4"}, {en: "0", hi: "0"}, {en: "2", hi: "2"}, {en: "5", hi: "5"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "Heating an ammonium salt with NaOH produces a gas with smell of:", textHi: "एक अमोनियम लवण को NaOH के साथ गर्म करने पर किस गंध वाली गैस उत्सर्जित होती है?", options: [{en: "Ammonia (NH_3)", hi: "अमोनिया (NH_3)"}, {en: "Hydrogen sulphide (H_2S)", hi: "हाइड्रोजन सल्फाइड (H_2S)"}, {en: "Carbon dioxide (CO_2)", hi: "कार्बन डाइऑक्साइड (CO_2)"}, {en: "No smell", hi: "कोई गंध नहीं"}], ans: 1 },
    { type: 'MCQ', textEn: "The geometry of IF_7 is:", textHi: "IF_7 की ज्यामिति है:", options: [{en: "Pentagonal bipyramidal", hi: "पंचकोणीय द्विपिरामिडीय"}, {en: "Square pyramidal", hi: "वर्ग पिरामिडीय"}, {en: "Trigonal bipyramidal", hi: "त्रिकोणीय द्विपिरामिडीय"}, {en: "Octahedral", hi: "अष्टफलकीय"}], ans: 1 },
    { type: 'MCQ', textEn: "In the decay series ^2^3⁸U → ^2⁰⁶Pb, how many α particles are emitted?", textHi: "क्षय श्रृंखला ^2^3⁸U → ^2⁰⁶Pb में, कितने α कण उत्सर्जित होते हैं?", options: [{en: "8", hi: "8"}, {en: "6", hi: "6"}, {en: "14", hi: "14"}, {en: "2", hi: "2"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "If 0.1 mol of P_4 reacts with excess O_2 to form P_4O_1_0, what is the mass of P_4O_1_0 produced (in g)?", textHi: "यदि 0.1 मोल P_4 अतिरिक्त O_2 के साथ प्रतिक्रिया करके P_4O_1_0 बनाता है, तो उत्पादित P_4O_1_0 का द्रव्यमान (ग्राम में) क्या है?", ans: "28.4" },
    { type: 'Numerical', textEn: "Bond energies: C-H=414, Cl-Cl=243, C-Cl=328, H-Cl=431 (kJ/mol). Calculate magnitude of ΔH for CH_4 + Cl_2 → CH_3Cl + HCl.", textHi: "बंध ऊर्जा: C-H=414, Cl-Cl=243, C-Cl=328, H-Cl=431 (kJ/mol)। CH_4 + Cl_2 → CH_3Cl + HCl के लिए ΔH का परिमाण (magnitude) ज्ञात करें।", ans: "102" },
    { type: 'Numerical', textEn: "For 2A + B → products. Rate law is r = k[A]^2[B]. If [A]=0.1M and [B]=0.2M gives rate 0.004, what is the rate logic? Enter 0.004", textHi: "2A + B → उत्पादों के लिए। दर नियम r = k[A]^2[B] है। यदि [A]=0.1M और [B]=0.2M दर 0.004 देता है, तो मान दर्ज करें:", ans: "0.004" },
    { type: 'Numerical', textEn: "Ksp of AgCl is 2x10^-¹⁰. The [Ag^+] in saturated solution with xM NaCl is 2x10^-⁴M. Find x (x 10⁶).", textHi: "AgCl का Ksp 2x10^-¹⁰ है। xM NaCl वाले संतृप्त विलयन में [Ag^+] 2x10^-⁴M है। x का मान (x 10⁶) ज्ञात करें।", ans: "1" },
    { type: 'Numerical', textEn: "Calculate E°_cell for Mg|Mg^2^+||Fe^2^+|Fe, given E°Mg=-2.37V, E°Fe=-0.44V.", textHi: "Mg|Mg^2^+||Fe^2^+|Fe के लिए E°_cell की गणना करें, दिया गया है E°Mg=-2.37V, E°Fe=-0.44V.", ans: "1.93" }
];
...
const mathQuestions_3: any[] = [
    ...
    { type: 'MCQ', textEn: "For the ellipse x^2/25 + y^2/16 = 1, its foci are:", textHi: "दीर्घवृत्त x^2/25 + y^2/16 = 1 के लिए, इसकी नाभियाँ (foci) हैं:", options: [{en: "(±3,0)", hi: "(±3,0)"}, {en: "(±4,0)", hi: "(±4,0)"}, {en: "(±5,0)", hi: "(±5,0)"}, {en: "(±9,0)", hi: "(±9,0)"}], ans: 1 },
    { type: 'MCQ', textEn: "In how many ways can 10 people sit in a circle if A never sits with B?", textHi: "10 लोग एक घेरे (circle) में कितने तरीकों से बैठ सकते हैं यदि A कभी भी B के साथ नहीं बैठता है?", options: [{en: "9! - 2x8!", hi: "9! - 2x8! (or ⁸P_8 x 7)"}, {en: "8! x 2", hi: "8! x 2"}, {en: "10!", hi: "10!"}, {en: "9!", hi: "9!"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The solution to sin^3x + cos^3x = 1 is:", textHi: "sin^3x + cos^3x = 1 का हल है:", options: [{en: "nπ", hi: "nπ"}, {en: "π/2 + 2nπ", hi: "π/2 + 2nπ"}, {en: "π/4 + nπ", hi: "π/4 + nπ"}, {en: "0", hi: "0"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "If a_n = n^2 - n, what is the sum of the first 10 terms (S_1_0)?", textHi: "यदि a_n = n^2 - n है, तो पहले 10 पदों का योग (S_1_0) क्या है?", options: [{en: "235", hi: "235"}, {en: "330", hi: "330 (385-55)"}, {en: "505", hi: "505"}, {en: "285", hi: "285"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The value of ∫ x^2 e^x dx is:", textHi: "∫ x^2 e^x dx का मान है:", options: [{en: "e^x (x^2 - 2x + 2) + C", hi: "e^x (x^2 - 2x + 2) + C"}, {en: "e^x x^2 + C", hi: "e^x x^2 + C"}, {en: "x^3e^x/3 + C", hi: "x^3e^x/3 + C"}, {en: "e^x (x^2+2) + C", hi: "e^x (x^2+2) + C"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The center of the circle x^2 + y^2 - 4x - 6y + 9 = 0 is:", textHi: "वृत्त x^2 + y^2 - 4x - 6y + 9 = 0 का केंद्र है:", options: [{en: "(2, 3)", hi: "(2, 3)"}, {en: "(1, 2)", hi: "(1, 2)"}, {en: "(3, 2)", hi: "(3, 2)"}, {en: "(2, 2)", hi: "(2, 2)"}], ans: 1 },
    { type: 'MCQ', textEn: "The asymptotes of the hyperbola x^2/9 - y^2/4 = 1 are:", textHi: "अतिपरवलय x^2/9 - y^2/4 = 1 के अनंतस्पर्शी (asymptotes) हैं:", options: [{en: "y = ±(2/3)x", hi: "y = ±(2/3)x"}, {en: "y = ±(3/2)x", hi: "y = ±(3/2)x"}, {en: "y = ±2x", hi: "y = ±2x"}, {en: "y = ±x/2", hi: "y = ±x/2"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "Evaluate ∫_0^(π/2) sin^3x dx.", textHi: "मान ज्ञात करें: ∫_0^(π/2) sin^3x dx.", ans: "1.33" },
    { type: 'Numerical', textEn: "For matrix A = [1 1; 0 2], find the magnitude of A^-¹(2,1) element x 10 (i.e., if 0.5 then 5). Element is 0, so 0?", textHi: "A = [1 1; 0 2] के लिए, व्युत्क्रम A^-¹ का तत्व (2,1) क्या होगा? (शून्य है तो 0 दर्ज करें)", ans: "0" },
    { type: 'Numerical', textEn: "The distance from the vertex to the focus in the parabola y^2 = 8x is:", textHi: "परवलय y^2 = 8x में शीर्ष से नाभि (focus) तक की दूरी कितनी है?", ans: "2" },
    { type: 'Numerical', textEn: "A bag contains 3 red and 4 blue balls. If 3 balls are drawn, what is the probability (multiplied by 100) of getting exactly 2 red balls? (18/35 x 100 ≈ 51.4)", textHi: "एक थैले में 3 लाल और 4 नीली गेंदें हैं। यदि 3 गेंदें निकाली जाती हैं, तो ठीक 2 लाल गेंदें मिलने की प्रायिकता (x 100) क्या होगी? (लगभग 51.4)", ans: "51.4" }
];
