...
const physicsQuestions_2: any[] = [
    ...
    { type: 'MCQ', textEn: "What is the unit of current density J?", textHi: "धारा घनत्व J की इकाई क्या है?", options: [{en: "A/m^2", hi: "A/m^2"}, {en: "A/m", hi: "A/m"}, {en: "Am^2", hi: "Am^2"}, {en: "A/s", hi: "A/s"}], ans: 1 },
    { type: 'MCQ', textEn: "What is the formula for stored energy in a capacitor?", textHi: "संधारित्र में संचित ऊर्जा का सूत्र क्या है?", options: [{en: "CV", hi: "CV"}, {en: "1/2 CV^2", hi: "1/2 CV^2"}, {en: "V/C", hi: "V/C"}, {en: "C/V", hi: "C/V"}], ans: 2 },
    ...
    { type: 'Numerical', textEn: "A body starts from rest and moves with an acceleration of 4 m/s^2 for 5 sec. What will be the final velocity?", textHi: "एक पिंड विरामावस्था से शुरू होता है और 5 सेकंड के लिए 4 m/s^2 के त्वरण से गति करता है। अंतिम वेग क्या होगा?", ans: "20" },
...
const chemistryQuestions_2: any[] = [
    { type: 'MCQ', textEn: "2.016g H_2 + 32g O_2 → H_2O. Excess mass?", textHi: "2.016g H_2 + 32g O_2 → H_2O. शेष बचा द्रव्यमान (Excess mass) क्या है?", options: [{en: "14g O_2", hi: "14g O_2"}, {en: "2g H_2", hi: "2g H_2"}, {en: "0g", hi: "0g"}, {en: "16g O_2", hi: "16g O_2"}], ans: 4 },
    { type: 'MCQ', textEn: "For Zn|Zn^2^+(0.01M)||H^+(1M)|H_2, E°=0.76V. E_cell= ?", textHi: "Zn|Zn^2^+(0.01M)||H^+(1M)|H_2 के लिए, E°=0.76V. E_cell= ?", options: [{en: "0.92V", hi: "0.92V"}, {en: "0.76V", hi: "0.76V"}, {en: "0.60V", hi: "0.60V"}, {en: "1.0V", hi: "1.0V"}], ans: 1 },
    { type: 'MCQ', textEn: "[CoF_6]^3^- is:", textHi: "[CoF_6]^3^- है:", options: [{en: "sp^3d^2, high spin", hi: "sp^3d^2, उच्च चक्रण"}, {en: "d^2sp^3, low spin", hi: "d^2sp^3, निम्न चक्रण"}, {en: "sp^3d^2, low spin", hi: "sp^3d^2, निम्न चक्रण"}, {en: "d^2sp^3, high spin", hi: "d^2sp^3, उच्च चक्रण"}], ans: 1 },
    { type: 'MCQ', textEn: "C_6H_6 + CH_3COCl/AlCl_3 →? Major product", textHi: "C_6H_6 + CH_3COCl/AlCl_3 →? मुख्य उत्पाद", options: [{en: "Acetophenone", hi: "एसीटोफीनोन"}, {en: "Toluene", hi: "टॉलूईन"}, {en: "o/p methyl acetophenone", hi: "o/p मिथाइल एसीटोफीनोन"}, {en: "Chlorobenzene", hi: "क्लोरोबेंजीन"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "Bond order of O_2^-:", textHi: "O_2^- की आबंध कोटि (Bond order):", options: [{en: "1.5", hi: "1.5"}, {en: "2", hi: "2"}, {en: "2.5", hi: "2.5"}, {en: "1", hi: "1"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "N_2O has structure:", textHi: "N_2O की संरचना है:", options: [{en: "N≡N-O", hi: "N≡N-O"}, {en: "N=N=O", hi: "N=N=O"}, {en: "N-N≡O", hi: "N-N≡O"}, {en: "N=N-O", hi: "N=N-O"}], ans: 1 },
    { type: 'MCQ', textEn: "For N_2 + 3H_2 ⇌ 2NH_3, Kp/Kc =", textHi: "N_2 + 3H_2 ⇌ 2NH_3 के लिए, Kp/Kc =", options: [{en: "RT^{-2}", hi: "RT^{-2}"}, {en: "RT^2", hi: "RT^2"}, {en: "RT^{-1}", hi: "RT^{-1}"}, {en: "1", hi: "1"}], ans: 1 },
    { type: 'MCQ', textEn: "n-factor for Cr_2O_7^2^- to Cr^3^+?", textHi: "Cr_2O_7^2^- से Cr^3^+ के लिए n-factor क्या है?", options: [{en: "6", hi: "6"}, {en: "3", hi: "3"}, {en: "12", hi: "12"}, {en: "1", hi: "1"}], ans: 1 },
    { type: 'MCQ', textEn: "Cannizzaro reaction is given by:", textHi: "कैनिज़ारो अभिक्रिया किसके द्वारा दी जाती है?", options: [{en: "HCHO", hi: "HCHO"}, {en: "CH_3CHO", hi: "CH_3CHO"}, {en: "C_6H_5CHO", hi: "C_6H_5CHO"}, {en: "HCHO and C_6H_5CHO both", hi: "HCHO और C_6H_5CHO दोनों"}], ans: 4 },
    { type: 'MCQ', textEn: "IE order: Li < Be > B Reason:", textHi: "आयनन ऊर्जा (IE) का क्रम: Li < Be > B कारण:", options: [{en: "Half-filled", hi: "अर्ध-पूरित"}, {en: "s^2 stable configuration", hi: "s^2 स्थिर विन्यास"}, {en: "Size", hi: "आकार"}, {en: "Shielding", hi: "परिरक्षण"}], ans: 2 },
    { type: 'MCQ', textEn: "Unit of rate constant (k) for second order reaction?", textHi: "द्वितीय कोटि की अभिक्रिया के लिए दर नियतांक (k) की इकाई क्या है?", options: [{en: "L mol^-¹ s^-¹", hi: "L mol^-¹ s^-¹"}, {en: "s^-¹", hi: "s^-¹"}, {en: "mol L^-¹ s^-¹", hi: "mol L^-¹ s^-¹"}, {en: "L^2 mol^-^2 s^-¹", hi: "L^2 mol^-^2 s^-¹"}], ans: 1 },
    { type: 'MCQ', textEn: "Violet colour of [Ti(H_2O)_6]^3^+ is due to:", textHi: "[Ti(H_2O)_6]^3^+ का बैंगनी रंग किसके कारण होता है?", options: [{en: "d-d transition", hi: "d-d संक्रमण"}, {en: "Charge Transfer", hi: "आवेश स्थानांतरण"}, {en: "f-f transition", hi: "f-f संक्रमण"}, {en: "π-π* transition", hi: "π-π* संक्रमण"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "Mn^2^+ is very stable due to:", textHi: "Mn^2^+ बहुत स्थिर होता है, इसका कारण है:", options: [{en: "d⁵ half-filled stability", hi: "d⁵ अर्ध-पूरित स्थिरता"}, {en: "High IE", hi: "उच्च IE"}, {en: "Small size", hi: "छोटा आकार"}, {en: "Low hydration energy", hi: "कम जलयोजन ऊर्जा"}], ans: 1 },
    ...
    { type: 'Numerical', textEn: "% yield if theoretical yield of CO_2 is 44g and actual yield is 40g:", textHi: "यदि CO_2 की सैद्धांतिक उपज 44g है और वास्तविक उपज 40g है, तो % उपज (yield) है:", ans: "91" },
    { type: 'Numerical', textEn: "E for Cu^2^+(0.1M)|Cu || Ag^+(0.01M)|Ag, E°=0.46V. E= ? (Use 0.059 in log term)", textHi: "Cu^2^+(0.1M)|Cu || Ag^+(0.01M)|Ag के लिए E, E°=0.46V. E= ?", ans: "0.52" },
    { type: 'Numerical', textEn: "ΔU for CH_4 + 2O_2 → CO_2 + 2H_2O(g), ΔH=-890kJ (RT≈2.3kJ). ΔU = ?", textHi: "CH_4 + 2O_2 → CO_2 + 2H_2O(g) के लिए, ΔH=-890kJ (RT≈2.3kJ). ΔU = ? (kJ में)", ans: "-878" },
    { type: 'Numerical', textEn: "A first-order reaction has k=0.0693 min^-¹. What is its t1/2 (in min)?", textHi: "प्रथम कोटि की अभिक्रिया के लिए k=0.0693 min^-¹ है। इसका t1/2 (मिनट में) क्या है?", ans: "10" },
    { type: 'Numerical', textEn: "For HA ⇌ H^++A^-, Ka=10^-⁵, [HA]=0.1M. Degree of dissociation α in terms of x x 10^-^3. Find x.", textHi: "HA ⇌ H^++A^- के लिए, Ka=10^-⁵, [HA]=0.1M. वियोजन की मात्रा α का मान x x 10^-^3 है। x ज्ञात करें।", ans: "10" }
];
...
const mathQuestions_2: any[] = [
    ...
    { type: 'MCQ', textEn: "If the roots of the equation x^2 + 2x + 3 = 0 are α and β, then α^2 + β^2 is:", textHi: "यदि समीकरण x^2 + 2x + 3 = 0 के मूल α और β हैं, तो α^2 + β^2 का मान है:", options: [{en: "-2", hi: "-2"}, {en: "2", hi: "2"}, {en: "4", hi: "4"}, {en: "-4", hi: "-4"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The derivative of ln(sec x) is:", textHi: "ln(sec x) का अवकलज है:", options: [{en: "sec x tan x", hi: "sec x tan x"}, {en: "tan x", hi: "tan x"}, {en: "sec^2 x", hi: "sec^2 x"}, {en: "1/sec x", hi: "1/sec x"}], ans: 2 },
    { type: 'MCQ', textEn: "If y = x^4, then d^2y/dx^2 at x = 1 is:", textHi: "यदि y = x^4 है, तो x = 1 पर d^2y/dx^2 है:", options: [{en: "4", hi: "4"}, {en: "12", hi: "12"}, {en: "24", hi: "24"}, {en: "16", hi: "16"}], ans: 2 },
    { type: 'MCQ', textEn: "The value of ∫sec^2x dx is:", textHi: "∫sec^2x dx का मान है:", options: [{en: "cot x + C", hi: "cot x + C"}, {en: "tan x + C", hi: "tan x + C"}, {en: "sec x tan x + C", hi: "sec x tan x + C"}, {en: "sec^3x + C", hi: "sec^3x + C"}], ans: 2 },
    { type: 'MCQ', textEn: "What is the area of a circle with radius r?", textHi: "त्रिज्या r वाले वृत्त का क्षेत्रफल क्या है?", options: [{en: "2πr", hi: "2πr"}, {en: "πr^2", hi: "πr^2"}, {en: "4πr^2", hi: "4πr^2"}, {en: "π^2r", hi: "π^2r"}], ans: 2 },
    { type: 'MCQ', textEn: "The value of ∫_0^(π/2) cos x dx is:", textHi: "∫_0^(π/2) cos x dx का मान है:", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "-1", hi: "-1"}, {en: "π/2", hi: "π/2"}], ans: 2 },
    { type: 'MCQ', textEn: "The general solution of dy/dx = y is:", textHi: "अवकल समीकरण dy/dx = y का सामान्य हल है:", options: [{en: "y = Ce^x", hi: "y = Ce^x"}, {en: "y = e^x + C", hi: "y = e^x + C"}, {en: "y^2 = x + C", hi: "y^2 = x + C"}, {en: "y = Cx", hi: "y = Cx"}], ans: 1 },
    ...
    { type: 'MCQ', textEn: "The cross product of basic unit vectors: i x j equals:", textHi: "मूल एकक सदिशों का सदिश गुणनफल: i x j किसके बराबर है?", options: [{en: "0", hi: "0"}, {en: "k", hi: "k"}, {en: "-k", hi: "-k"}, {en: "1", hi: "1"}], ans: 2 },
    ...
    { type: 'MCQ', textEn: "The radius of the sphere x^2 + y^2 + z^2 = 16 is:", textHi: "x^2 + y^2 + z^2 = 16 गोले की त्रिज्या है:", options: [{en: "16", hi: "16"}, {en: "8", hi: "8"}, {en: "4", hi: "4"}, {en: "2", hi: "2"}], ans: 3 },
    ...
    { type: 'MCQ', textEn: "For independent events A and B, P(A∩B) = ", textHi: "स्वतंत्र घटनाओं A और B के लिए, P(A∩B) =", options: [{en: "P(A) + P(B)", hi: "P(A) + P(B)"}, {en: "P(A) - P(B)", hi: "P(A) - P(B)"}, {en: "P(A) / P(B)", hi: "P(A) / P(B)"}, {en: "P(A) x P(B)", hi: "P(A) x P(B)"}], ans: 4 },
    { type: 'MCQ', textEn: "Value of loge(e) is:", textHi: "loge(e) का मान है:", options: [{en: "0", hi: "0"}, {en: "1", hi: "1"}, {en: "e", hi: "e"}, {en: "10", hi: "10"}], ans: 2 },
    { type: 'Numerical', textEn: "Evaluate 5^3 (5 raised to power 3).", textHi: "5^3 का मान ज्ञात कीजिए।", ans: "125" },
