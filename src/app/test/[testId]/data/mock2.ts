...
const mathQuestions_2: any[] = [
    ...
    { type: 'MCQ', textEn: "If |z - 3 + 2i| = 4, then the difference between maximum and minimum value of |z| is:", textHi: "यदि |z - 3 + 2i| = 4, तो |z| के अधिकतम और न्यूनतम मान के बीच का अंतर है:", options: [{en: "4", hi: "4"}, {en: "√13", hi: "√13"}, {en: "8", hi: "8"}, {en: "2√13", hi: "2√13"}], ans: 3 },
