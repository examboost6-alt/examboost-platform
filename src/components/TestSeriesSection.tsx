...
export default function TestSeriesSection() {
    return (
        <section className="py-12 sm:py-16 md:py-24 bg-white dark:bg-[#060D1A] relative z-10 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-8 sm:mb-12 gap-4 sm:gap-6">
                    <div className="max-w-2xl">
                        ...
                        <motion.h2
                            ...
                            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-black tracking-tight text-slate-900 dark:text-white leading-[1.1]"
                        >
