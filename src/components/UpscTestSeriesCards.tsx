...
export default function UpscTestSeriesCards({ examName = 'UPSC CSE Prelims' }: { examName?: string }) {
    const [selectedPackage, setSelectedPackage] = useState<"essential" | "ultimate" | null>(null);

    // Deep, detailed data for UPSC CSE Prelims
    const packages = {
        essential: {
            ...
            description: `Targeted practice for ${examName} 2026 with reliable OMR style simulators.`,
            testsIncluded: [
                "25 Full Length Mock Tests (15 GS + 10 CSAT)",
                "80 Subject-wise Tests (Polity, Economy, Geography, History)"
            ],
            detailedPapers: [
                { title: "GS Paper-I Mocks", count: 15, detail: "Strictly matching UPSC's 100-question, 200-mark format (-0.66 negative marking)." },
                { title: "CSAT Paper-II Mocks", count: 10, detail: "80-question qualifying tests (33% passing) evaluating aptitude & comprehension." },
                { title: "Subject-wise & NCERT Tests", count: 60, detail: "Extensive foundational practice on basic standard textbooks (NCERTs)." },
                { title: "Current Affairs Monthly", count: 20, detail: "Current Events of National and International Importance." },
            ],
            features: [
                { title: "Instant Solutions", detail: "Detailed step-by-step text answers immediately after submission." },
                { title: "All India Rank", detail: "Compare your performance with thousands of serious UPSC aspirants." },
                { title: "Performance Analysis", detail: "Check your accuracy and time taken per question to manage the 120 minutes." },
            ],
            otherFeatures: [
                "Real Exam Like UPSC Standard Questions",
                "Unlimited Reattempts",
                "Subject-wise Score Analysis",
                "Desktop & Mobile Access"
            ],
            bestFor: ["Self-studying students", "Exam pattern familiarization", "Current Affairs tracking"]
        },
        ultimate: {
            name: `ExamBoost ${examName} Ultimate`,
            price: "₹1499", // Premium but highly affordable
            image: "https://images.unsplash.com/photo-1541829070764-84a7d30dd3f3?auto=format&fit=crop&q=80&w=800",
            description: "The most comprehensive Prelims package with 10-year PYQs, AI analytics, and CSAT mastery.",
            testsIncluded: [
                "50 Full Length Mock Tests (30 GS + 20 CSAT)",
                "150 Chapter & Topic-wise Practice Tests",
                "10-Year Previous Year Papers (Topic Wise)",
                "Unlimited Custom Practice Mode"
            ],
            detailedPapers: [
                { title: "GS Paper-I & CSAT Combo", count: 50, detail: "Attempt GS in morning and CSAT in afternoon sequentially." },
                { title: "10-Year Previous Papers", count: 10, detail: "Actual UPSC papers with detailed elimination-strategy solutions." },
                { title: "NCERT & Standard Books Tests", count: 150, detail: "Deep dive into Laxmikanth, Spectrum, Ramesh Singh & Core NCERTs." },
                { title: "Custom Generator", count: "∞", detail: "Select subject (e.g. Art & Culture), difficulty, and build custom tests." },
            ],
            features: [
                { title: "Elimination Tactic Video Solutions", detail: "Video explanations demonstrating how to eliminate options in GS Paper I." },
                { title: "CSAT Weakness Detection", detail: "System automatically identifies if you are struggling with Math, Reasoning, or Comprehension." },
                { title: "Dynamic Cut-off Predictor", detail: "Based on paper difficulty, predicts your chances against 90-100 marks cut-off." },
            ],
            otherFeatures: [
                "Question Bookmark & Revise System",
                "Economic Survey & Budget Special Tests",
                "Smart AI Practice Mode (Targeted weak areas)",
                "All India Advanced Leaderboard",
                "Downloadable PDF Question Banks"
            ],
            bestFor: ["Serious Aspirants targeting IFoS cut-offs", "CSAT Strugglers", "Comprehensive Prelims Preparation"]
        }
    };
    ...
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1.5 flex flex-col group">
                    <div className="p-8 pb-0">
                        ...
                        <div className="flex items-baseline gap-2 mb-8 border-b border-slate-100 dark:border-slate-800 pb-8">
                            ...
                            <span className="text-slate-500 font-medium">/ Complete Prelims</span>
                        </div>
                    </div>
                ...
                {/* Ultimate Card */}
                <div className="bg-gradient-to-br from-[#0e3b6d] to-[#0a2342] dark:from-[#0b2b4e] dark:to-[#051324] border-[#1c5598]/30 rounded-3xl overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-1.5 shadow-xl shadow-[#0e3b6d]/30 flex flex-col relative group">
                    ...
                    <div className="p-8 pb-0 relative z-10">
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-400 text-amber-900 font-black text-xs uppercase tracking-wider mb-4 shadow-sm">
                            <Target className="w-3.5 h-3.5" /> LBSNAA Dream
                        </div>
                        ...
                        <div className="flex items-baseline gap-2 mb-8 border-b border-white/20 pb-8">
                            ...
                            <span className="text-white/60 font-medium">/ Complete Prelims</span>
                        </div>
                    </div>
                    ...
                    <div className="px-8 flex flex-col flex-1 relative z-10">
                        <ul className="space-y-4 mb-10 flex-1">
                            ...
                            <li className="flex items-start gap-3 font-medium text-amber-300">
                                ...
                                <span>Includes Economic Survey & Video Solutions</span>
                            </li>
                        </ul>
                        ...
                        <div className="flex flex-col sm:grid sm:grid-cols-2 gap-4 pb-8">
                            ...
                            <button className="w-full flex items-center justify-center gap-2 py-4 px-4 rounded-xl font-bold bg-white text-[#0a2342] hover:bg-amber-50 transition-transform hover:-translate-y-0.5 shadow-xl shadow-white/10 text-sm md:text-base shrink-0">
                                <ShoppingCart className="w-5 h-5" /> Enroll Now
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[2rem] w-full max-w-5xl max-h-[95vh] flex flex-col shadow-2xl border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-200 mt-auto mb-auto sm:my-auto">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-6 md:p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 gap-4">
                            <div>
                                <div className="flex items-center gap-3 mb-1">
                                    ...
                                    {selectedPackage === 'ultimate' && <span className="text-xs bg-[#0e3b6d] shadow-[#0e3b6d]/30 text-white px-3 py-1 rounded-full font-bold uppercase tracking-wider shadow-sm">Pro Package</span>}
                                </div>
                                <p className="text-slate-500 font-medium">{packages[selectedPackage].description}</p>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="text-[#0e3b6d] dark:text-[#2f75bd] font-black text-3xl">{packages[selectedPackage].price}</div>
                                <button
                                ...
                                <div className="lg:col-span-7 border-r border-slate-100 dark:border-slate-800 p-6 md:p-8 bg-white dark:bg-slate-950 space-y-8">
                                    ...
                                    <div>
                                        <h4 className="flex items-center gap-2 text-xl font-bold text-slate-900 dark:text-white mb-6">
                                            <BookOpen className="w-6 h-6 text-[#0e3b6d] dark:text-[#2f75bd]" /> Detailed CSE Prelims Breakdown
                                        </h4>
                                            ...
                                            {packages[selectedPackage].detailedPapers.map((paper, idx) => (
                                                <div key={idx} className="flex flex-col sm:flex-row sm:items-center gap-4 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900">
                                                    <div className="w-16 h-16 rounded-xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex flex-col items-center justify-center shrink-0">
                                                        <div className="text-xl font-black text-[#0e3b6d] dark:text-[#2f75bd] leading-none">{paper.count}</div>
                                        ...
                                        <div className="mt-8 p-6 bg-slate-50 dark:bg-[#0e3b6d]/10 rounded-2xl border border-slate-200 dark:border-[#0e3b6d]/30 flex gap-4">
                                            <Layers className="w-8 h-8 text-[#0e3b6d] shrink-0" />
                                            <div>
                                                <h5 className="font-bold text-slate-900 dark:text-white mb-1">Authentic OMR Marking Limits</h5>
                                                <p className="text-sm text-slate-600 dark:text-slate-400">Our simulator accurately represents negative markings (1/3rd penalty per wrong answer), keeping the pressure identical to real UPSC Civil Services Evaluation.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="lg:col-span-5 p-6 md:p-8 bg-slate-50/50 dark:bg-slate-900/30 space-y-8">
                                    ...
                                    <div>
                                        <h4 className="flex items-center gap-2 text-lg font-bold text-slate-900 dark:text-white mb-5">
                                            <Target className="w-5 h-5 text-[#0e3b6d] dark:text-[#2f75bd]" /> Analysis & Mentorship
                                        </h4>
                                    ...
                                    <div>
                                        <h4 className="flex items-center gap-2 text-lg font-bold text-slate-900 dark:text-white mb-4">
                                            <Award className="w-5 h-5 text-[#0e3b6d] dark:text-[#2f75bd]" /> Platform Features
                                        </h4>
                        ...
                        <div className="p-4 sm:p-6 border-t border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-[0_-10px_30px_-10px_rgba(0,0,0,0.05)] rounded-b-[2rem]">
                            <div className="flex items-center gap-4 text-slate-600 dark:text-slate-400 text-sm font-medium w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0 hide-scrollbar">
                                <span className="flex items-center gap-1.5 shrink-0"><Calendar className="w-4 h-4 text-slate-400" /> May 2026 Prelims</span>
                            ...
                            <button className="w-full sm:w-auto flex items-center justify-center gap-2 py-4 px-10 rounded-xl font-bold text-lg bg-[#0e3b6d] hover:bg-[#0a2342] shadow-[#0e3b6d]/30 text-white transition-transform hover:-translate-y-1 shadow-lg shrink-0">
