                    ...
                    <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
                        ...
                        >
                            ...
                            <div className="relative border-[10px] border-darkText dark:border-slate-800 rounded-[3rem] shadow-2xl bg-white overflow-hidden aspect-[9/19] transform rotate-y-[-10deg] rotate-x-[5deg] hover:rotate-0 transition-transform duration-700 z-20">
                                ...
                                <div className="w-full h-full bg-slate-50 dark:bg-slate-900 flex flex-col pt-12 p-4">
                                    ...
                                    <div className="flex justify-between items-center mb-6">
                                        <div>
                                            <p className="text-darkText dark:text-white font-bold text-lg">Hello, Rahul</p>
                                            <p className="text-grayText dark:text-slate-400 text-xs font-semibold">Ready to practice?</p>
                                        </div>
                                    ...
                                    <h4 className="font-bold text-darkText dark:text-white text-sm mb-3">Today's Goals</h4>

                                    <div className="space-y-3">
                                        {[
                                            { title: "Daily Current Affairs Quiz", status: "10/10 Comp", color: "bg-accent" },
                                            { title: "Quantitative Sectional Test", status: "Start", color: "bg-primary" }
                                        ].map((g, i) => (
                                            <div key={i} className="bg-white dark:bg-slate-800 rounded-xl p-3 border border-slate-100 dark:border-slate-700 shadow-sm flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm font-bold text-darkText dark:text-white">{g.title}</p>
                                                    <p className="text-xs font-semibold text-grayText dark:text-slate-400">{g.status}</p>
                                                </div>
                            ...
                            <motion.div
                                ...
                                className="hidden md:flex absolute -left-12 bottom-1/4 glass-card p-3 rounded-xl items-center gap-3 shadow-2xl border border-white/20 z-30"
                            >
                                <div className="w-10 h-10 bg-accent rounded-full flex items-center justify-center text-darkText"><MdCheckCircleOutline className="w-5 h-5" /></div>
                                <div>
                                    <p className="font-bold text-darkText dark:text-white text-sm">New Test Added</p>
                                    <p className="text-xs text-grayText dark:text-slate-400 font-medium pt-0.5">Mock Test #45 Live</p>
                                </div>
                            </motion.div>
